...
class World(object):
    ...
    def tick(self, clock):
        ...
        self.hud.tick(self, self.mapname, clock, self.camera_manager)
        return True
...
class CameraManager(object):
    ...
    def image_callback(self, weak_self, image):
    ...
    def set_sensor(self, index, notify=True):
        ...
        if needs_respawn:
            ...
            # circular reference.
            weak_self = weakref.ref(self)
            self.sensor.listen(lambda image: self.image_callback(weak_self, image))
        if notify:
