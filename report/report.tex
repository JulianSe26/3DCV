...
\begin{figure}[h]
    ...
    \begin{subfigure}[c]{\textwidth}
        \centering
        \includegraphics[width=0.6\textwidth]{figures/generated/cyclist_original.PNG}
        \subcaption{Original base scenario} 
    \end{subfigure}
    \begin{subfigure}[c]{\textwidth}
        \centering
        \includegraphics[width=0.6\textwidth]{figures/generated/cyclist_1.PNG}
        \subcaption{Example for generated scenario (1)}
    \end{subfigure}
    \begin{subfigure}[c]{\textwidth}
        \centering
        \includegraphics[width=0.6\textwidth]{figures/generated/cyclist_2.PNG}
        \subcaption{Example for generated scenario (2)}
    \end{subfigure}
